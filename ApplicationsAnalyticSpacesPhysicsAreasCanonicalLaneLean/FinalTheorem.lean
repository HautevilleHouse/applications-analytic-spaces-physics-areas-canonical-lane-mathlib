import HautevilleHouse.ApplicationsAnalyticSpacesPhysicsAreasCanonicalLaneLean.BridgeLemmas
import HautevilleHouse.ApplicationsAnalyticSpacesPhysicsAreasCanonicalLaneLean.GateLemmas
import HautevilleHouse.ApplicationsAnalyticSpacesPhysicsAreasCanonicalLaneLean.TheoremStatement
...
theorem constrained_theorem_closure (A : AdmissibleClass) :
  ...
  refine ⟨bridge_from_admissible_class A, gate_from_admissible_class A, classical_source_boundary_carried_checked⟩
...
theorem conditional_route_closure_checked (A : AdmissibleClass) :
  ...
  refine ⟨constrained_theorem_closure A, classical_source_boundary_carried_checked⟩
